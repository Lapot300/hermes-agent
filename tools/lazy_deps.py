...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # Mirrored by the pyproject `doc-extract` extra so the pin is represented
    # in uv.lock, while remaining lazy-only and excluded from `[all]`.
    "tool.doc_extract": ("firecrawl-anydoc==0.2.3",),
